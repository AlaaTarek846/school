...
<html lang="ar" dir="rtl" data-nav-layout="vertical" data-theme-mode="light" data-header-styles="light" data-menu-styles="dark" data-toggled="close">
    <head>
        ...
        <!-- Bootstrap Css -->
        <link id="style" href="{{asset('dashboard/libs/bootstrap/css/bootstrap.rtl.min.css')}}" rel="stylesheet">
        ...
        <!-- Prism CSS -->
        <link rel="stylesheet" href="{{asset('dashboard/libs/prismjs/themes/prism-coy.min.css')}}">

        <!-- Sweetalerts CSS -->
        <link rel="stylesheet" href="{{asset('dashboard/libs/sweetalert2/sweetalert2.min.css')}}">
        <link href="{{ asset('dashboard/css/vanillatoasts.css') }}" rel="stylesheet" type="text/css" id="app-stylesheet" />
...
{{--                        </div>--}}
        ...
        <!-- Loader -->
        <div id="loader" >
            <img src="{{asset('dashboard/images/media/loader.svg')}}" alt="">
        </div>
        <!-- Loader -->
