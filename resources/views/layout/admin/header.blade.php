...
{{--                                <img src="{{asset('dashboard/images/ecommerce/jpg/1.jpg')}}" alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3">--}}
...
{{--                        <li class="dropdown-item">--}}
{{--                            <div class="d-flex align-items-start cart-dropdown-item">--}}
{{--                                <img src="{{asset('dashboard/images/ecommerce/jpg/3.jpg')}}" alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3">--}}
{{--                                <div class="flex-grow-1">--}}
{{--                                    <div class="d-flex align-items-start justify-content-between mb-0">--}}
{{--                                        <div class="mb-0 fs-13 text-dark fw-semibold">--}}
...
{{--                        <li class="dropdown-item">--}}
{{--                            <div class="d-flex align-items-start cart-dropdown-item">--}}
{{--                                <img src="{{asset('dashboard/images/ecommerce/jpg/5.jpg')}}" alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3">--}}
{{--                                <div class="flex-grow-1">--}}
{{--                                    <div class="d-flex align-items-start justify-content-between mb-0">--}}
{{--                                        <div class="mb-0 fs-13 text-dark fw-semibold">--}}
...
{{--                        <li class="dropdown-item">--}}
{{--                            <div class="d-flex align-items-start cart-dropdown-item">--}}
{{--                                <img src="{{asset('dashboard/images/ecommerce/jpg/4.jpg')}}" alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3">--}}
{{--                                <div class="flex-grow-1">--}}
{{--                                    <div class="d-flex align-items-start justify-content-between mb-0">--}}
{{--                                        <div class="mb-0 fs-13 text-dark fw-semibold">--}}
...
{{--                        <li class="dropdown-item">--}}
{{--                            <div class="d-flex align-items-start cart-dropdown-item">--}}
{{--                                <img src="{{asset('dashboard/images/ecommerce/jpg/6.jpg')}}" alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3">--}}
{{--                                <div class="flex-grow-1">--}}
{{--                                    <div class="d-flex align-items-start justify-content-between mb-0">--}}
{{--                                        <div class="mb-0 fs-13 text-dark fw-semibold">--}}
...
{{--                                                    <img src="{{asset('dashboard/images/apps/figma.png')}}" alt="">--}}
{{--                                                </span>--}}
...
{{--                                    <div class="text-center p-3 related-app">--}}
{{--                                                <span class="avatar avatar-sm avatar-rounded">--}}
{{--                                                    <img src="{{asset('dashboard/images/apps/microsoft-powerpoint.png')}}" alt="">--}}
{{--                                                </span>--}}
...
{{--                                    <div class="text-center p-3 related-app">--}}
{{--                                                <span class="avatar avatar-sm avatar-rounded">--}}
{{--                                                    <img src="{{asset('dashboard/images/apps/microsoft-word.png')}}" alt="">--}}
{{--                                                </span>--}}
...
{{--                                    <div class="text-center p-3 related-app">--}}
{{--                                                <span class="avatar avatar-sm avatar-rounded">--}}
{{--                                                    <img src="{{asset('dashboard/images/apps/calender.png')}}" alt="">--}}
{{--                                                </span>--}}
...
{{--                                    <div class="text-center p-3 related-app">--}}
{{--                                                <span class="avatar avatar-sm avatar-rounded">--}}
{{--                                                    <img src="{{asset('dashboard/images/apps/sketch.png')}}" alt="">--}}
{{--                                                </span>--}}
...
{{--                                    <div class="text-center p-3 related-app">--}}
{{--                                                <span class="avatar avatar-sm avatar-rounded">--}}
{{--                                                    <img src="{{asset('dashboard/images/apps/google-docs.png')}}" alt="">--}}
{{--                                                </span>--}}
...
{{--                                    <div class="text-center p-3 related-app">--}}
{{--                                                <span class="avatar avatar-sm avatar-rounded">--}}
{{--                                                    <img src="{{asset('dashboard/images/apps/google.png')}}" alt="">--}}
{{--                                                </span>--}}
...
{{--                                    <div class="text-center p-3 related-app">--}}
{{--                                                <span class="avatar avatar-sm avatar-rounded">--}}
{{--                                                    <img src="{{asset('dashboard/images/apps/translate.png')}}" alt="">--}}
{{--                                                </span>--}}
...
{{--                                    <div class="text-center p-3 related-app">--}}
{{--                                                <span class="avatar avatar-sm avatar-rounded">--}}
{{--                                                    <img src="{{asset('dashboard/images/apps/google-sheets.png')}}" alt="">--}}
{{--                                                </span>--}}
...
{{--            </div>--}}
            ...
            <!-- Start::header-element -->
            @include('layout.admin.partials.header-user')
            <!-- End::header-element -->
