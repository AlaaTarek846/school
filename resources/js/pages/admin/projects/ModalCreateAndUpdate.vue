                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 mb-2">
                          ...
                          <div class="invalid-feedback">
                            ...
                            <span v-if="v$.sort.integer?.$invalid">
                              {{ $t('validation.ValueMustBeInteger') }}<br />
                            </span>
                        ...
                        <div class="col-md-6 mt-2">
                         ...
                         <div class="col-md-6 mb-2">
                          <label class="form-label">{{ $t('global.tag_ar') }}</label>

                          <input
                            type="text"
                            class="form-control form-control-lg"
                            v-model="v$.tag_ar.$model"
                            :class="{
                              'is-invalid': v$.tag_ar.$error || errors['tag_ar'],
                              'is-valid': !v$.tag_ar.$invalid && !errors['tag_ar']
                            }"
                          />

                          <div class="invalid-feedback">
                           <span v-if="v$.tag_ar.required.$invalid">
                            {{ $t('validation.fieldRequired') }}<br />
                          </span>

                           <span v-if="v$.tag_ar.minLength?.$invalid">
                            {{ $t('validation.CountryArIsMustHaveAtMost') }}
                            {{ v$.tag_ar.minLength.$params.min }}
                            {{ $t('validation.Letters') }}<br />
                          </span>

                            <span v-if="v$.tag_ar.maxLength?.$invalid">
                              {{ $t('validation.CountryArIsMustHaveAtLeast') }}
                              {{ v$.tag_ar.maxLength.$params.max }}
                              {{ $t('validation.Letters') }}<br />
                            </span>

                            <template v-if="errors['tag_ar']">
                              <error-message
                                v-for="(errorMessage, index) in errors['tag_ar']"
                                :key="index"
                              >
                                {{ errorMessage }}
                              </error-message>
                        ...
                        <div class="col-md-6 mb-2">
                          <label class="form-label">{{ $t('global.tag_en') }}</label>

                          <input
                            type="text"
                            class="form-control form-control-lg"
                            v-model="v$.tag_en.$model"
                            :class="{
                              'is-invalid': v$.tag_en.$error || errors['tag_en'],
                              'is-valid': !v$.tag_en.$invalid && !errors['tag_en']
                            }"
                          />

                          <div class="invalid-feedback">
                            <span v-if="v$.tag_en.required.$invalid">
                              {{ $t('validation.fieldRequired') }}<br />
                            </span>

                            <span v-if="v$.tag_en.minLength?.$invalid">
                              {{ $t('validation.CountryEnIsMustHaveAtMost') }}
                              {{ v$.tag_en.minLength.$params.min }}
                              {{ $t('validation.Letters') }}<br />
                            </span>

                            <span v-if="v$.tag_en.maxLength?.$invalid">
                              {{ $t('validation.CountryEnIsMustHaveAtLeast') }}
                              {{ v$.tag_en.maxLength.$params.max }}
                              {{ $t('validation.Letters') }}<br />
                            </span>

                            <template v-if="errors['tag_en']">
                              <error-message
                                v-for="(errorMessage, index) in errors['tag_en']"
                                :key="index"
                              >
                                {{ errorMessage }}
                              </error-message>
                       ...
                       <div class="col-md-6 mb-2">
                         ...
                         <Editor ref="descRef" :modules="customModules" v-model="v$.overview_ar.$model"></Editor>
                        ...
                        <div class="col-md-6 mb-2">
                          ...
                          <Editor ref="descRef" :modules="customModules" v-model="v$.overview_en.$model"></Editor>
...
<script setup>
  ...
  function defaultData(){
    ...
    submitData.data.tag_ar = '';
    submitData.data.tag_en = '';
      ...
      if (props.type != 'edit') {
        ...
        adminApi.get(`projects/${id.value}`)
            .then((res) => {
              ...
              submitData.data.tag_en = l.tag_en;
              submitData.data.tag_ar = l.tag_ar;
  ...
  const rules = computed(() => {
    return {
      ...
      tag_en: {required,minLength: minLength(2),maxLength: maxLength(191)},
      tag_ar: {required,minLength: minLength(2),maxLength: maxLength(191)},
  ...
  const AddSubmit = () =>  {
      ...
      formData.append('tag_en', submitData.data.tag_en);
      formData.append('tag_ar', submitData.data.tag_ar);
